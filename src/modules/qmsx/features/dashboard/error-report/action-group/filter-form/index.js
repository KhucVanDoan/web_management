...
function ActionGroupFilterForm() {
  ...
  const { actions: dashboardActions } = useDashboardActionGroup()
  ...
  const handleSubmit = () => {
    ...
    switch (qcStageId) {
      ...
      case STAGE_OPTION.PRO_EXPORT:
        ...
        dashboardActions.getActionGroupDashboard(params)
        break
      case STAGE_OPTION.PRODUCTION_INPUT:
      case STAGE_OPTION.PRODUCTION_OUTPUT:
...
export default ActionGroupFilterForm
