...
const breadcrumbs = [
  ...
  {
    route: ROUTE.DEFINE_QUALITY_ALERT.DETAIL_PRODUCTION_OUTPUT.PATH,
    title: ROUTE.DEFINE_QUALITY_ALERT.DETAIL_PRODUCTION_OUTPUT.TITLE,
  },
]

function DefineQualityAlertProductionOutputDetail() {
  ...
  return (
    <Page
      ...
      title={t('menu.defineQualityAlertProductionOutputDetail')}
      onBack={backToList}
      loading={isLoading}
    >
...
export default DefineQualityAlertProductionOutputDetail
