...
const breadcrumbs = [
  ...
  {
    route: ROUTE.DEFINE_QUALITY_ALERT.DETAIL_OUTPUT.PATH,
    title: ROUTE.DEFINE_QUALITY_ALERT.DETAIL_OUTPUT.TITLE,
  },
]

function DefineQualityAlertOutputDetail() {
  ...
  return (
    <Page
      ...
      title={t('menu.defineQualityAlertOutputDetail')}
      onBack={backToList}
      loading={isLoading}
    >
...
export default DefineQualityAlertOutputDetail
