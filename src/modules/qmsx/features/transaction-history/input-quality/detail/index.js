...
const breadcrumbs = [
  ...
  {
    route: ROUTE.TRANSACTION_HISTORY.INPUT_QUALITY_DETAIL.PATH,
    title: ROUTE.TRANSACTION_HISTORY.INPUT_QUALITY_DETAIL.TITLE,
  },
]

function InputQualityDetail() {
...
export default InputQualityDetail
