...
const breadcrumbs = [
  ...
  {
    route: ROUTE.TRANSACTION_HISTORY.PRODUCTION_OUTPUT_QUALITY_DETAIL.PATH,
    title: ROUTE.TRANSACTION_HISTORY.PRODUCTION_OUTPUT_QUALITY_DETAIL.TITLE,
  },
]

function ProductionOutputQualityDetail() {
  ...
  const backToList = () => {
    history.push(ROUTE.TRANSACTION_HISTORY.LIST.PATH)
  }

  useEffect(() => {
    actions.getDetailProductionOutputQualityTransactionHistory(
      { id: id },
      _,
      backToList,
    )
...
export default ProductionOutputQualityDetail
