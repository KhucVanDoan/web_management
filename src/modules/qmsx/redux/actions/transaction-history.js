...
//Action: reset state
export const RESET_TRANSACTION_HISTORY_STATE = 'RESET_TRANSACTION_HISTORY_STATE'
 ...
 * @returns {object}
 */
export function searchProductionOutputQualityTransactionHistorySuccess(payload) {
  return {
 ...
 * @returns {object}
 */
export function searchProductionInputQualityProductPreviousTransactionHistorySuccess(payload) {
  return {
 ...
 * @returns {object}
 */
export function searchProductionInputQualityMaterialTransactionHistorySuccess(payload) {
  return {
 ...
 * @returns {object}
 */
export function getDetailProductionInputQualityProductPreviousTransactionHistorySuccess(payload) {
  return {
 ...
 * @returns {object}
 */
export function getDetailProductionInputQualityMaterialTransactionHistorySuccess(payload) {
  return {
 ...
 * @returns {object}
 */
export function getDetailProductionOutputQualityTransactionHistorySuccess(payload) {
  return {
