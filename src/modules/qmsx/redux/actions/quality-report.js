...
export const SEARCH_PROD_INPUT_PRODUCT_PREV_QUALITY_REPORT_START =
  'QMSX_SEARCH_PROD_INPUT_PRODUCT_PREV_QUALITY_REPORT_START'
export const SEARCH_PROD_INPUT_PRODUCT_PREV_QUALITY_REPORT_SUCCESS =
  'QMSX_SEARCH_PROD_INPUT_PRODUCT_PREV_QUALITY_REPORT_SUCCESS'
export const SEARCH_PROD_INPUT_PRODUCT_PREV_QUALITY_REPORT_FAIL =
  'QMSX_SEARCH_PROD_INPUT_PRODUCT_PREV_QUALITY_REPORT_FAIL'

// Action: Search production input material quality report
export const SEARCH_PROD_INPUT_MATERIAL_QUALITY_REPORT_START =
  'QMSX_SEARCH_PROD_INPUT_MATERIAL_QUALITY_REPORT_START'
export const SEARCH_PROD_INPUT_MATERIAL_QUALITY_REPORT_SUCCESS =
  'QMSX_SEARCH_PROD_INPUT_MATERIAL_QUALITY_REPORT_SUCCESS'
export const SEARCH_PROD_INPUT_MATERIAL_QUALITY_REPORT_FAIL =
  'QMSX_SEARCH_PROD_INPUT_MATERIAL_QUALITY_REPORT_FAIL'

// Action: Get MO list for production QC
export const GET_MO_LIST_START = 'QMSX_GET_MO_LIST_START'
export const GET_MO_LIST_SUCCESS = 'QMSX_GET_MO_LIST_SUCCESS'
export const GET_MO_LIST_FAIL = 'QMSX_GET_MO_LIST_FAIL'

// Action: Get item list by MO
export const GET_ITEM_LIST_BY_MO_START = 'QMSX_GET_ITEM_LIST_BY_MO_START'
export const GET_ITEM_LIST_BY_MO_SUCCESS = 'QMSX_GET_ITEM_LIST_BY_MO_SUCCESS'
export const GET_ITEM_LIST_BY_MO_FAIL = 'QMSX_GET_ITEM_LIST_BY_MO_FAIL'

// Action: Get item list by PO
export const GET_ITEM_LIST_BY_PO_START = 'QMSX_GET_ITEM_LIST_BY_PO_START'
export const GET_ITEM_LIST_BY_PO_SUCCESS = 'QMSX_GET_ITEM_LIST_BY_PO_SUCCESS'
export const GET_ITEM_LIST_BY_PO_FAIL = 'QMSX_GET_ITEM_LIST_BY_PO_FAIL'

// Action: Get item list by SO
export const GET_ITEM_LIST_BY_SO_START = 'QMSX_GET_ITEM_LIST_BY_SO_START'
export const GET_ITEM_LIST_BY_SO_SUCCESS = 'QMSX_GET_ITEM_LIST_BY_SO_SUCCESS'
export const GET_ITEM_LIST_BY_SO_FAIL = 'QMSX_GET_ITEM_LIST_BY_SO_FAIL'

// Action: Get item list by PRO
export const GET_ITEM_LIST_BY_PRO_START = 'QMSX_GET_ITEM_LIST_BY_PRO_START'
export const GET_ITEM_LIST_BY_PRO_SUCCESS = 'QMSX_GET_ITEM_LIST_BY_PRO_SUCCESS'
export const GET_ITEM_LIST_BY_PRO_FAIL = 'QMSX_GET_ITEM_LIST_BY_PRO_FAIL'

// Action: Get order list by stage
export const GET_ORDER_LIST_BY_STAGE_START = 'QMSX_SEARCH_ORDER_BY_STAGE_START'
export const GET_ORDER_LIST_BY_STAGE_SUCCESS =
  'QMSX_SEARCH_ORDER_BY_STAGE_SUCCESS'
export const GET_ORDER_LIST_BY_STAGE_FAIL = 'QMSX_SEARCH_ORDER_BY_STAGE_FAIL'

// Action: reset state
export const RESET_QUALITY_REPORT_STATE = 'QMSX_RESET_QUALITY_REPORT_STATE'
