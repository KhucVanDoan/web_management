...
export const SEARCH_ERROR_REPORT_START = 'SEARCH_ERROR_REPORT_START'
export const SEARCH_ERROR_REPORT_SUCCESS = 'SEARCH_ERROR_REPORT_SUCCESS'
export const SEARCH_ERROR_REPORT_FAIL = 'SEARCH_ERROR_REPORT_FAIL'
// Action: Get confirm error-report
export const CONFIRM_ERROR_REPORT_START = 'CONFIRM_ERROR_REPORT_START'
export const CONFIRM_ERROR_REPORT_SUCCESS = 'CONFIRM_ERROR_REPORT_SUCCESS'
export const CONFIRM_ERROR_REPORT_FAIL = 'CONFIRM_ERROR_REPORT_FAIL'
// Action: Get reject error-report
export const REJECT_ERROR_REPORT_START = 'REJECT_ERROR_REPORT_START'
export const REJECT_ERROR_REPORT_SUCCESS = 'REJECT_ERROR_REPORT_SUCCESS'
export const REJECT_ERROR_REPORT_FAIL = 'REJECT_ERROR_REPORT_FAIL'
// Action: Get detail error-report
export const GET_ERROR_REPORT_DETAIL_START = 'GET_ERROR_REPORT_DETAIL_START'
export const GET_ERROR_REPORT_DETAIL_SUCCESS = 'GET_ERROR_REPORT_DETAIL_SUCCESS'
export const GET_ERROR_REPORT_DETAIL_FAIL = 'GET_ERROR_REPORT_DETAIL_FAIL'
//Action: reset state
export const RESET_ERROR_REPORT_DETAIL_STATE = 'RESET_ERROR_REPORT_DETAIL_STATE'
/**
