//@Define Action
// Action: Get List
export const SEARCH_ACTION_GROUP_START = 'SEARCH_ACTION_GROUP_START'
export const SEARCH_ACTION_GROUP_SUCCESS = 'SEARCH_ACTION_GROUP_SUCCESS'
export const SEARCH_ACTION_GROUP_FAIL = 'SEARCH_ACTION_GROUP_FAIL'
// Action: Create
export const CREATE_ACTION_GROUP_START = 'CREATE_ACTION_GROUP_START'
export const CREATE_ACTION_GROUP_SUCCESS = 'CREATE_ACTION_GROUP_SUCCESS'
export const CREATE_ACTION_GROUP_FAIL = 'CREATE_ACTION_GROUP_FAIL'
// Action: Update
export const UPDATE_ACTION_GROUP_START = 'UPDATE_ACTION_GROUP_START'
export const UPDATE_ACTION_GROUP_SUCCESS = 'UPDATE_ACTION_GROUP_SUCCESS'
export const UPDATE_ACTION_GROUP_FAIL = 'UPDATE_ACTION_GROUP_FAIL'
// Action: Delete
export const DELETE_ACTION_GROUP_START = 'DELETE_ACTION_GROUP_START'
export const DELETE_ACTION_GROUP_SUCCESS = 'DELETE_ACTION_GROUP_SUCCESS'
export const DELETE_ACTION_GROUP_FAIL = 'DELETE_ACTION_GROUP_FAIL'
// Action: Get detail
export const GET_ACTION_GROUP_DETAIL_START = 'GET_ACTION_GROUP_DETAIL_START'
export const GET_ACTION_GROUP_DETAIL_SUCCESS = 'GET_ACTION_GROUP_DETAIL_SUCCESS'
export const GET_ACTION_GROUP_DETAIL_FAIL = 'GET_ACTION_GROUP_DETAIL_FAIL'
// Action: Get reset detail
export const RESET_ACTION_GROUP_DETAIL_STATE = 'RESET_ACTION_GROUP_DETAIL_STATE'
