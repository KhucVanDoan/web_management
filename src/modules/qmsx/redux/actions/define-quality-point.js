export const SEARCH_QUALITY_POINT_START = 'SEARCH_QUALITY_POINT_START'
export const SEARCH_QUALITY_POINT_SUCCESS = 'SEARCH_QUALITY_POINT_SUCCESS'
export const SEARCH_QUALITY_POINT_FAIL = 'SEARCH_QUALITY_POINT_FAIL'

export const CREATE_QUALITY_POINT_START = 'CREATE_QUALITY_POINT_START'
export const CREATE_QUALITY_POINT_SUCCESS = 'CREATE_QUALITY_POINT_SUCCESS'
export const CREATE_QUALITY_POINT_FAIL = 'CREATE_QUALITY_POINT_FAIL'

export const UPDATE_QUALITY_POINT_START = 'UPDATE_QUALITY_POINT_START'
export const UPDATE_QUALITY_POINT_SUCCESS = 'UPDATE_QUALITY_POINT_SUCCESS'
export const UPDATE_QUALITY_POINT_FAIL = 'UPDATE_QUALITY_POINT_FAIL'

export const DELETE_QUALITY_POINT_START = 'DELETE_QUALITY_POINT_START'
export const DELETE_QUALITY_POINT_SUCCESS = 'DELETE_QUALITY_POINT_SUCCESS'
export const DELETE_QUALITY_POINT_FAIL = 'DELETE_QUALITY_POINT_FAIL'

export const GET_QUALITY_POINT_DETAIL_START = 'GET_QUALITY_POINT_DETAIL_START'
export const GET_QUALITY_POINT_DETAIL_SUCCESS =
  'GET_QUALITY_POINT_DETAIL_SUCCESS'
export const GET_QUALITY_POINT_DETAIL_FAIL = 'GET_QUALITY_POINT_DETAIL_FAIL'

export const CONFIRM_QUALITY_POINT_START = 'CONFIRM_QUALITY_POINT_START'
export const CONFIRM_QUALITY_POINT_SUCCESS = 'CONFIRM_QUALITY_POINT_SUCCESS'
export const CONFIRM_QUALITY_POINT_FAIL = 'CONFIRM_QUALITY_POINT_FAIL'
