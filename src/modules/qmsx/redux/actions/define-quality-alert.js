// Action: Get list
export const SEARCH_QUALITY_ALERT_START = 'QMSX_SEARCH_QUALITY_ALERT_START'
export const SEARCH_QUALITY_ALERT_SUCCESS = 'QMSX_SEARCH_QUALITY_ALERT_SUCCESS'
export const SEARCH_QUALITY_ALERT_FAIL = 'QMSX_SEARCH_QUALITY_ALERT_FAIL'
// Action: Create
export const CREATE_QUALITY_ALERT_START = 'QMSX_CREATE_QUALITY_ALERT_START'
export const CREATE_QUALITY_ALERT_SUCCESS = 'QMSX_CREATE_QUALITY_ALERT_SUCCESS'
export const CREATE_QUALITY_ALERT_FAIL = 'QMSX_CREATE_QUALITY_ALERT_FAIL'
// Action: Update
export const UPDATE_QUALITY_ALERT_START = 'QMSX_UPDATE_QUALITY_ALERT_START'
export const UPDATE_QUALITY_ALERT_SUCCESS = 'QMSX_UPDATE_QUALITY_ALERT_SUCCESS'
export const UPDATE_QUALITY_ALERT_FAIL = 'QMSX_UPDATE_QUALITY_ALERT_FAIL'
// Action: Delete
export const DELETE_QUALITY_ALERT_START = 'QMSX_DELETE_QUALITY_ALERT_START'
export const DELETE_QUALITY_ALERT_SUCCESS = 'QMSX_DELETE_QUALITY_ALERT_SUCCESS'
export const DELETE_QUALITY_ALERT_FAIL = 'QMSX_DELETE_QUALITY_ALERT_FAIL'
// Action: Get detail
export const GET_QUALITY_ALERT_DETAIL_START =
  'QMSX_GET_QUALITY_ALERT_DETAIL_START'
export const GET_QUALITY_ALERT_DETAIL_SUCCESS =
  'QMSX_GET_QUALITY_ALERT_DETAIL_SUCCESS'
export const GET_QUALITY_ALERT_DETAIL_FAIL =
  'QMSX_GET_QUALITY_ALERT_DETAIL_FAIL'
// Action: Confirm list
export const CONFIRM_QUALITY_ALERT_START = 'QMSX_CONFIRM_QUALITY_ALERT_START'
export const CONFIRM_QUALITY_ALERT_SUCCESS =
  'QMSX_CONFIRM_QUALITY_ALERT_SUCCESS'
export const CONFIRM_QUALITY_ALERT_FAIL = 'QMSX_CONFIRM_QUALITY_ALERT_FAIL'
// Action: reset detail
export const RESET_QUALITY_ALERT_DETAIL_STATE =
  'QMSX_RESET_QUALITY_ALERT_DETAIL_STATE'
// Action: Get Mo
export const GET_MO_START = 'QMSX_GET_MO_START'
export const GET_MO_SUCCESS = 'QMSX_GET_MO_SUCCESS'
export const GET_MO_FAIL = 'QMSX_GET_MO_FAIL'
// Action: Get product by mo-id
export const GET_PRODUCTS_BY_MO_START = 'QMSX_GET_PRODUCTS_BY_MO_START'
export const GET_PRODUCTS_BY_MO_SUCCESS = 'QMSX_GET_PRODUCTS_BY_MO_SUCCESS'
export const GET_PRODUCTS_BY_MO_FAIL = 'QMSX_GET_PRODUCTS_BY_MO_FAIL'
// Action: Get routing by product-id
export const GET_ROUTING_BY_PRODUCT_START = 'QMSX_GET_ROUTING_BY_PRODUCT_START'
export const GET_ROUTING_BY_PRODUCT_SUCCESS =
  'QMSX_GET_ROUTING_BY_PRODUCT_SUCCESS'
export const GET_ROUTING_BY_PRODUCT_FAIL = 'QMSX_GET_ROUTING_BY_PRODUCT_FAIL'
// Action: Get producing-step by routing-id
export const GET_PRODUCING_STEP_BY_ROUTING_START =
  'QMSX_GET_PRODUCING_STEP_BY_ROUTING_START'
export const GET_PRODUCING_STEP_BY_ROUTING_SUCCESS =
  'QMSX_GET_PRODUCING_STEP_BY_ROUTING_SUCCESS'
export const GET_PRODUCING_STEP_BY_ROUTING_FAIL =
  'QMSX_GET_PRODUCING_STEP_BY_ROUTING_FAIL'
// Action: Get Order by StageQcValue
export const GET_ORDER_BY_STAGE_QC_VALUES_START =
  'QMSX_GET_ORDER_BY_STAGE_QC_VALUES_START'
export const GET_ORDER_BY_STAGE_QC_VALUES_SUCCESS =
  'QMSX_GET_ORDER_BY_STAGE_QC_VALUES_SUCCESS'
export const GET_ORDER_BY_STAGE_QC_VALUES_FAIL =
  'QMSX_GET_ORDER_BY_STAGE_QC_VALUES_FAIL'
// Action: Get product by orderId
export const GET_PRODUCT_BY_ORDER_ID_START =
  'QMSX_GET_PRODUCT_BY_ORDER_ID_START'
export const GET_PRODUCT_BY_ORDER_ID_SUCCESS =
  'QMSX_GET_PRODUCT_BY_ORDER_ID_SUCCESS'
export const GET_PRODUCT_BY_ORDER_ID_FAIL = 'QMSX_GET_PRODUCT_BY_ORDER_ID_FAIL'
// Action: Get warehouse by orderId and productId
export const GET_WAREHOUSE_BY_ORDER_ID_AND_PRODUCT_ID_START =
  'QMSX_GET_WAREHOUSE_BY_ORDER_ID_AND_PRODUCT_ID_START'
export const GET_WAREHOUSE_BY_ORDER_ID_AND_PRODUCT_ID_SUCCESS =
  'QMSX_GET_WAREHOUSE_BY_ORDER_ID_AND_PRODUCT_ID_SUCCESS'
export const GET_WAREHOUSE_BY_ORDER_ID_AND_PRODUCT_ID_FAIL =
  'QMSX_GET_WAREHOUSE_BY_ORDER_ID_AND_PRODUCT_ID_FAIL'
