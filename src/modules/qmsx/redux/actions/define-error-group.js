...
export const SEARCH_ERROR_GROUP_START = 'SEARCH_ERROR_GROUP_START'
export const SEARCH_ERROR_GROUP_SUCCESS = 'SEARCH_ERROR_GROUP_SUCCESS'
export const SEARCH_ERROR_GROUP_FAIL = 'SEARCH_ERROR_GROUP_FAIL'

// Action: Create error-group
export const CREATE_ERROR_GROUP_START = 'CREATE_ERROR_GROUP_START'
export const CREATE_ERROR_GROUP_SUCCESS = 'CREATE_ERROR_GROUP_SUCCESS'
export const CREATE_ERROR_GROUP_FAIL = 'CREATE_ERROR_GROUP_FAIL'

// Action: Update error-group
export const UPDATE_ERROR_GROUP_START = 'UPDATE_ERROR_GROUP_START'
export const UPDATE_ERROR_GROUP_SUCCESS = 'UPDATE_ERROR_GROUP_SUCCESS'
export const UPDATE_ERROR_GROUP_FAIL = 'UPDATE_ERROR_GROUP_FAIL'

// Action: Delete error-group
export const DELETE_ERROR_GROUP_START = 'DELETE_ERROR_GROUP_START'
export const DELETE_ERROR_GROUP_SUCCESS = 'DELETE_ERROR_GROUP_SUCCESS'
export const DELETE_ERROR_GROUP_FAIL = 'DELETE_ERROR_GROUP_FAIL'

// Action: Get detail error-group
export const GET_ERROR_GROUP_DETAIL_START = 'GET_ERROR_GROUP_DETAIL_START'
export const GET_ERROR_GROUP_DETAIL_SUCCESS = 'GET_ERROR_GROUP_DETAIL_SUCCESS'
export const GET_ERROR_GROUP_DETAIL_FAIL = 'GET_ERROR_GROUP_DETAIL_FAIL'

// Action: upload file
export const UPLOAD_ERROR_GROUP_DATA_START = 'UPLOAD_ERROR_GROUP_DATA_START'
export const UPLOAD_ERROR_GROUP_DATA_SUCCESS = 'UPLOAD_ERROR_GROUP_DATA_SUCCESS'
export const UPLOAD_ERROR_GROUP_DATA_FAIL = 'UPLOAD_ERROR_GROUP_DATA_FAIL'
...
//Action: reset state
export const RESET_ERROR_GROUP_DETAIL_STATE = 'RESET_ERROR_GROUP_DETAIL_STATE'
/**
