const style = (theme) => ({
  root: {
    ...
    '.back-ground-success > .gantt_task_progress_wrapper > .gantt_task_progress':
      {
        backgroundColor: '#a09f9f !important',
        borderRight: 'none',
      },
    '.back-ground-delay': { backgroundColor: '#f97a7a !important' },
    '.back-ground-white': { backgroundColor: '#ffff !important' },
