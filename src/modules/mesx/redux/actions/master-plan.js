export const SEARCH_MASTER_PLANS_START = 'MESX_SEARCH_MASTER_PLANS_START'
export const SEARCH_MASTER_PLANS_SUCCESS = 'MESX_SEARCH_MASTER_PLANS_SUCCESS'
export const SEARCH_MASTER_PLANS_FAILED = 'MESX_SEARCH_MASTER_PLANS_FAILED'

export const GET_MASTER_PLAN_DETAILS_START =
  'MESX_GET_MASTER_PLAN_DETAILS_START'
export const GET_MASTER_PLAN_DETAILS_SUCCESS =
  'MESX_GET_MASTER_PLAN_DETAILS_SUCCESS'
export const GET_MASTER_PLAN_DETAILS_FAILED =
  'MESX_GET_MASTER_PLAN_DETAILS_FAILED'

export const GET_JOB_DETAILS_START = 'MESX_GET_JOB_DETAILS_START'
export const GET_JOB_DETAILS_SUCCESS = 'MESX_GET_JOB_DETAILS_SUCCESS'
export const GET_JOB_DETAILS_FAILED = 'MESX_GET_JOB_DETAILS_FAILED'

export const CREATE_MASTER_PLAN_START = 'MESX_CREATE_MASTER_PLAN_START'
export const CREATE_MASTER_PLAN_SUCCESS = 'MESX_CREATE_MASTER_PLAN_SUCCESS'
export const CREATE_MASTER_PLAN_FAILED = 'MESX_CREATE_MASTER_PLAN_FAILED'

export const UPDATE_MASTER_PLAN_START = 'MESX_UPDATE_MASTER_PLAN_START'
export const UPDATE_MASTER_PLAN_SUCCESS = 'MESX_UPDATE_MASTER_PLAN_SUCCESS'
export const UPDATE_MASTER_PLAN_FAILED = 'MESX_UPDATE_MASTER_PLAN_FAILED'

export const GET_MODERATION_SUGGEST_SPREAD_START =
  'MESX_GET_MODERATION_SUGGEST_SPREAD_START'
export const GET_MODERATION_SUGGEST_SPREAD_SUCCESS =
  'MESX_GET_MODERATION_SUGGEST_SPREAD_SUCCESS'
export const GET_MODERATION_SUGGEST_SPREAD_FAILED =
  'MESX_GET_MODERATION_SUGGEST_SPREAD_FAILED'

export const SUBMIT_MODERATION_INPUT_START =
  'MESX_SUBMIT_MODERATION_INPUT_START'
export const SUBMIT_MODERATION_INPUT_SUCCESS =
  'MESX_SUBMIT_MODERATION_INPUT_SUCCESS'
export const SUBMIT_MODERATION_INPUT_FAILED =
  'MESX_SUBMIT_MODERATION_INPUT_FAILED'

export const RESET_MODERATION_SUGGEST_SPREAD =
  'MESX_RESET_MODERATION_SUGGEST_SPREAD'
export const RESET_MASTER_PLAN_DETAIL = 'MESX_RESET_MASTER_PLAN_DETAIL'

export const EXTEND_DEADLINE_START = 'MESX_EXTEND_DEADLINE_START'
export const EXTEND_DEADLINE_SUCCESS = 'MESX_EXTEND_DEADLINE_SUCCESS'
export const EXTEND_DEADLINE_FAILED = 'MESX_EXTEND_DEADLINE_FAILED'

export const GET_PRODUCING_STEP_DETAIL_START =
  'MESX_GET_PRODUCING_STEP_DETAIL_START'
export const GET_PRODUCING_STEP_DETAIL_SUCCESS =
  'MESX_GET_PRODUCING_STEP_DETAIL_SUCCESS'
export const GET_PRODUCING_STEP_DETAIL_FAILED =
  'MESX_GET_PRODUCING_STEP_DETAIL_FAILED'

export const APPROVE_MASTER_PLAN = 'MESX_APPROVE_MASTER_PLAN'
export const APPROVE_MASTER_PLAN_SUCCESS = 'MESX_APPROVE_MASTER_PLAN_SUCCESS'
export const APPROVE_MASTER_PLAN_FAILED = 'MESX_APPROVE_MASTER_PLAN_FAILED'

export const REJECT_MASTER_PLAN = 'MESX_REJECT_MASTER_PLAN'
export const REJECT_MASTER_PLAN_SUCCESS = 'MESX_REJECT_MASTER_PLAN_SUCCESS'
export const REJECT_MASTER_PLAN_FAILED = 'MESX_REJECT_MASTER_PLAN_FAILED'

export const DELETE_MASTER_PLAN_START = 'MESX_DELETE_MASTER_PLAN_START'
