export const SEARCH_ITEMS_START = 'MESX_SEARCH_ITEMS_START'
export const SEARCH_ITEMS_SUCCESS = 'MESX_SEARCH_ITEMS_SUCCESS'
export const SEARCH_ITEMS_FAILED = 'MESX_SEARCH_ITEMS_FAILED'

export const CREATE_ITEM_START = 'MESX_CREATE_ITEM_START'
export const CREATE_ITEM_SUCCESS = 'MESX_CREATE_ITEM_SUCCESS'
export const CREATE_ITEM_FAILED = 'MESX_CREATE_ITEM_FAILED'

export const UPDATE_ITEM_START = 'MESX_UPDATE_ITEM_START'
export const UPDATE_ITEM_SUCCESS = 'MESX_UPDATE_ITEM_SUCCESS'
export const UPDATE_ITEM_FAILED = 'MESX_UPDATE_ITEM_FAILED'

export const DELETE_ITEM_START = 'MESX_DELETE_ITEM_START'
export const DELETE_ITEM_SUCCESS = 'MESX_DELETE_ITEM_SUCCESS'
export const DELETE_ITEM_FAILED = 'MESX_DELETE_ITEM_FAILED'

export const GET_ITEM_DETAILS_START = 'MESX_GET_ITEM_DETAILS_START'
export const GET_ITEM_DETAILS_SUCCESS = 'MESX_GET_ITEM_DETAILS_SUCCESS'
export const GET_ITEM_DETAILS_FAILED = 'MESX_GET_ITEM_DETAILS_FAILED'

export const RESET_ITEM_DETAILS_STATE = 'MESX_RESET_ITEM_DETAILS_STATE'
