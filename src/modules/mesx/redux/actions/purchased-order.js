export const SEARCH_PURCHASED_ORDERS_START =
  'MESX_SEARCH_PURCHASED_ORDERS_START'
export const SEARCH_PURCHASED_ORDERS_SUCCESS =
  'MESX_SEARCH_PURCHASED_ORDERS_SUCCESS'
export const SEARCH_PURCHASED_ORDERS_FAILED =
  'MESX_SEARCH_PURCHASED_ORDERS_FAILED'
...
export const UPDATE_PURCHASED_ORDER_START = 'MESX_UPDATE_PURCHASED_ORDER_START'
export const UPDATE_PURCHASED_ORDER_SUCCESS =
  'MESX_UPDATE_PURCHASED_ORDER_SUCCESS'
export const UPDATE_PURCHASED_ORDER_FAILED =
  'MESX_UPDATE_PURCHASED_ORDER_FAILED'

export const DELETE_PURCHASED_ORDER_START = 'MESX_DELETE_PURCHASED_ORDER_START'
export const DELETE_PURCHASED_ORDER_SUCCESS =
  'MESX_DELETE_PURCHASED_ORDER_SUCCESS'
export const DELETE_PURCHASED_ORDER_FAILED =
  'MESX_DELETE_PURCHASED_ORDER_FAILED'

export const GET_PURCHASED_ORDER_DETAILS_START =
  'MESX_GET_PURCHASED_ORDER_DETAILS_START'
export const GET_PURCHASED_ORDER_DETAILS_SUCCESS =
  'MESX_GET_PURCHASED_ORDER_DETAILS_SUCCESS'
export const GET_PURCHASED_ORDER_DETAILS_FAILED =
  'MESX_GET_PURCHASED_ORDER_DETAILS_FAILED'

export const CONFIRM_PURCHASED_ORDER_START =
  'MESX_CONFIRM_PURCHASED_ORDER_START'
export const CONFIRM_PURCHASED_ORDER_SUCCESS =
  'MESX_CONFIRM_PURCHASED_ORDER_SUCCESS'
export const CONFIRM_PURCHASED_ORDER_FAILED =
  'MESX_CONFIRM_PURCHASED_ORDER_FAILED'

export const REJECT_PURCHASED_ORDER_START = 'MESX_REJECT_PURCHASED_ORDER_START'
export const REJECT_PURCHASED_ORDER_SUCCESS =
  'MESX_REJECT_PURCHASED_ORDER_SUCCESS'
export const REJECT_PURCHASED_ORDER_FAILED =
  'MESX_REJECT_PURCHASED_ORDER_FAILED'

export const IMPORT_PURCHASED_ORDER_START = 'MESX_IMPORT_PURCHASED_ORDER_START'
export const IMPORT_PURCHASED_ORDER_SUCCESS =
  'MESX_IMPORT_PURCHASED_ORDER_SUCCESS'
export const IMPORT_PURCHASED_ORDER_FAILED =
  'MESX_IMPORT_PURCHASED_ORDER_FAILED'

export const GET_PURCHASED_ORDER_NOT_CREATE_POIMP_START =
  'MESX_GET_PURCHASED_ORDER_NOT_CREATE_POIMP_START'
export const GET_PURCHASED_ORDER_NOT_CREATE_POIMP_SUCCESS =
  'MESX_GET_PURCHASED_ORDER_NOT_CREATE_POIMP_SUCCESS'
export const GET_PURCHASED_ORDER_NOT_CREATE_POIMP_FAILED =
  'MESX_GET_PURCHASED_ORDER_NOT_CREATE_POIMP_FAILED'

export const RESET_PURCHASED_ORDER_DETAILS_STATE =
  'MESX_RESET_PURCHASED_ORDER_DETAILS_STATE'
/**
