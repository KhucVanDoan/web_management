export const SEARCH_ITEM_GROUPS_START = 'MESX_SEARCH_ITEM_GROUPS_START'
export const SEARCH_ITEM_GROUPS_SUCCESS = 'MESX_SEARCH_ITEM_GROUPS_SUCCESS'
export const SEARCH_ITEM_GROUPS_FAILED = 'MESX_SEARCH_ITEM_GROUPS_FAILED'

export const CREATE_ITEM_GROUP_START = 'MESX_CREATE_ITEM_GROUP_START'
export const CREATE_ITEM_GROUP_SUCCESS = 'MESX_CREATE_ITEM_GROUP_SUCCESS'
export const CREATE_ITEM_GROUP_FAILED = 'MESX_CREATE_ITEM_GROUP_FAILED'

export const UPDATE_ITEM_GROUP_START = 'MESX_UPDATE_ITEM_GROUP_START'
export const UPDATE_ITEM_GROUP_SUCCESS = 'MESX_UPDATE_ITEM_GROUP_SUCCESS'
export const UPDATE_ITEM_GROUP_FAILED = 'MESX_UPDATE_ITEM_GROUP_FAILED'

export const DELETE_ITEM_GROUP_START = 'MESX_DELETE_ITEM_GROUP_START'
export const DELETE_ITEM_GROUP_SUCCESS = 'MESX_DELETE_ITEM_GROUP_SUCCESS'
export const DELETE_ITEM_GROUP_FAILED = 'MESX_DELETE_ITEM_GROUP_FAILED'

export const GET_ITEM_GROUP_DETAILS_START = 'MESX_GET_ITEM_GROUP_DETAILS_START'
export const GET_ITEM_GROUP_DETAILS_SUCCESS =
  'MESX_GET_ITEM_GROUP_DETAILS_SUCCESS'
export const GET_ITEM_GROUP_DETAILS_FAILED =
  'MESX_GET_ITEM_GROUP_DETAILS_FAILED'

export const RESET_ITEM_GROUP_DETAILS_STATE =
  'MESX_RESET_ITEM_GROUP_DETAILS_STATE'
