export const GET_BOM_PRODUCING_STEP_START = 'MESX_GET_BOM_PRODUCING_STEP_START'
export const GET_BOM_PRODUCING_STEP_SUCCESS =
  'MESX_GET_BOM_PRODUCING_STEP_SUCCESS'
export const GET_BOM_PRODUCING_STEP_FAILED =
  'MESX_GET_BOM_PRODUCING_STEP_FAILED'

export const SEARCH_BOM_PRODUCING_STEP_START =
  'MESX_SEARCH_BOM_PRODUCING_STEP_START'
export const SEARCH_BOM_PRODUCING_STEP_SUCCESS =
  'MESX_SEARCH_BOM_PRODUCING_STEP_SUCCESS'
export const SEARCH_BOM_PRODUCING_STEP_FAILED =
  'MESX_SEARCH_BOM_PRODUCING_STEP_FAILED'

export const CREATE_BOM_PRODUCING_STEP_START =
  'MESX_CREATE_BOM_PRODUCING_STEP_START'
export const CREATE_BOM_PRODUCING_STEP_SUCCESS =
  'MESX_CREATE_BOM_PRODUCING_STEP_SUCCESS'
export const CREATE_BOM_PRODUCING_STEP_FAILED =
  'MESX_CREATE_BOM_PRODUCING_STEP_FAILED'

export const UPDATE_BOM_PRODUCING_STEP_START =
  'MESX_UPDATE_BOM_PRODUCING_STEP_START'
export const UPDATE_BOM_PRODUCING_STEP_SUCCESS =
  'MESX_UPDATE_BOM_PRODUCING_STEP_SUCCESS'
export const UPDATE_BOM_PRODUCING_STEP_FAILED =
  'MESX_UPDATE_BOM_PRODUCING_STEP_FAILED'

export const DELETE_BOM_PRODUCING_STEP_START =
  'MESX_DELETE_BOM_PRODUCING_STEP_START'
export const DELETE_BOM_PRODUCING_STEP_SUCCESS =
  'MESX_DELETE_BOM_PRODUCING_STEP_SUCCESS'
export const DELETE_BOM_PRODUCING_STEP_FAILED =
  'MESX_DELETE_BOM_PRODUCING_STEP_FAILED'

export const GET_BOM_PRODUCING_STEP_DETAILS_START =
  'MESX_GET_BOM_PRODUCING_STEP_DETAILS_START'
export const GET_BOM_PRODUCING_STEP_DETAILS_SUCCESS =
  'MESX_GET_BOM_PRODUCING_STEP_DETAILS_SUCCESS'
export const GET_BOM_PRODUCING_STEP_DETAILS_FAILED =
  'MESX_GET_BOM_PRODUCING_STEP_DETAILS_FAILED'

export const CONFIRM_BOM_PRODUCING_STEP_START =
  'MESX_CONFIRM_BOM_PRODUCING_STEP_START'
export const CONFIRM_BOM_PRODUCING_STEP_SUCCESS =
  'MESX_CONFIRM_BOM_PRODUCING_STEP_SUCCESS'
export const CONFIRM_BOM_PRODUCING_STEP_FAILED =
  'MESX_CONFIRM_BOM_PRODUCING_STEP_FAILED'

export const REJECT_BOM_PRODUCING_STEP_START =
  'MESX_REJECT_BOM_PRODUCING_STEP_START'
export const REJECT_BOM_PRODUCING_STEP_SUCCESS =
  'MESX_REJECT_BOM_PRODUCING_STEP_SUCCESS'
export const REJECT_BOM_PRODUCING_STEP_FAILED =
  'MESX_REJECT_BOM_PRODUCING_STEP_FAILED'
...
export const GET_BOM_PRODUCING_STEP_BOM_DETAILS_START =
  'MESX_GET_BOM_PRODUCING_STEP_BOM_DETAILS_START'
export const GET_BOM_PRODUCING_STEP_BOM_DETAILS_SUCCESS =
  'MESX_GET_BOM_PRODUCING_STEP_BOM_DETAILS_SUCCESS'
export const GET_BOM_PRODUCING_STEP_BOM_DETAILS_FAILED =
  'MESX_GET_BOM_PRODUCING_STEP_BOM_DETAILS_FAILED'

export const RESET_BOM_PRODUCING_STEP_DETAILS_STATE =
  'MESX_RESET_BOM_PRODUCING_STEP_DETAILS_STATE'
