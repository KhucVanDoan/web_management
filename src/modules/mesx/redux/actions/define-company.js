...
export const SEARCH_COMPANIES_START = 'MESX_SEARCH_COMPANIES_START'
export const SEARCH_COMPANIES_SUCCESS = 'MESX_SEARCH_COMPANIES_SUCCESS'
export const SEARCH_COMPANIES_FAILED = 'MESX_SEARCH_COMPANIES_FAILED'

export const CREATE_COMPANY_START = 'MESX_CREATE_COMPANY_START'
export const CREATE_COMPANY_SUCCESS = 'MESX_CREATE_COMPANY_SUCCESS'
export const CREATE_COMPANY_FAILED = 'MESX_CREATE_COMPANY_FAILED'

export const UPDATE_COMPANY_START = 'MESX_UPDATE_COMPANY_START'
export const UPDATE_COMPANY_SUCCESS = 'MESX_UPDATE_COMPANY_SUCCESS'
export const UPDATE_COMPANY_FAILED = 'MESX_UPDATE_COMPANY_FAILED'

export const DELETE_COMPANY_START = 'MESX_DELETE_COMPANY_START'
export const DELETE_COMPANY_SUCCESS = 'MESX_DELETE_COMPANY_SUCCESS'
export const DELETE_COMPANY_FAILED = 'MESX_DELETE_COMPANY_FAILED'

export const GET_COMPANY_DETAILS_START = 'MESX_GET_COMPANY_DETAILS_START'
export const GET_COMPANY_DETAILS_SUCCESS = 'MESX_GET_COMPANY_DETAILS_SUCCESS'
export const GET_COMPANY_DETAILS_FAILED = 'MESX_GET_COMPANY_DETAILS_FAILED'

export const RESET_COMPANY_DETAILS_STATE = 'MESX_RESET_COMPANY_DETAILS_STATE'
