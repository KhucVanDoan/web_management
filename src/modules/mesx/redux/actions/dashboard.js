export const GET_DASHBOARD_SUMMARY_START = 'MESX_GET_DASHBOARD_SUMMARY_START'
export const GET_DASHBOARD_IN_PROGRESS_MOS_START =
  'MESX_GET_DASHBOARD_IN_PROGRESS_MOS_START'
export const GET_DASHBOARD_IN_PROGRESS_MOS_SUCCESS =
  'MESX_GET_DASHBOARD_IN_PROGRESS_MOS_SUCCESS'
export const GET_DASHBOARD_SUMMARY_SUCCESS =
  'MESX_GET_DASHBOARD_SUMMARY_SUCCESS'
export const GET_DASHBOARD_MO_STATUS_START =
  'MESX_GET_DASHBOARD_MO_STATUS_START'
export const GET_DASHBOARD_MO_STATUS_SUCCESS =
  'MESX_GET_DASHBOARD_MO_STATUS_SUCCESS'
export const GET_DASHBOARD_FINISHED_ITEM_PROGRESS_START =
  'MESX_GET_DASHBOARD_FINISHED_ITEM_PROGRESS_START'
export const GET_DASHBOARD_FINISHED_ITEM_PROGRESS_SUCCESS =
  'MESX_GET_DASHBOARD_FINISHED_ITEM_PROGRESS_SUCCESS'
export const GET_DASHBOARD_QC_PRODUCING_STEP_PROGRESS_START =
  'MESX_GET_DASHBOARD_QC_PRODUCING_STEP_PROGRESS_START'
export const GET_DASHBOARD_QC_PRODUCING_STEP_PROGRESS_START_SUCCESS =
  'MESX_GET_DASHBOARD_QC_PRODUCING_STEP_PROGRESS_START_SUCCESS'
export const GET_DASHBOARD_PRODUCING_STEP_PROGRESS_START =
  'MESX_GET_DASHBOARD_PRODUCING_STEP_PROGRESS_START'
export const GET_DASHBOARD_PRODUCING_STEP_PROGRESS_START_SUCCESS =
  'MESX_GET_DASHBOARD_PRODUCING_STEP_PROGRESS_START_SUCCESS'
export const GET_DASHBOARD_FINISHED_ITEM_BY_MO_START =
  'MESX_GET_DASHBOARD_FINISHED_ITEM_BY_MO_START'
export const GET_DASHBOARD_ALL_ITEM_BY_MO_START =
  'MESX_GET_DASHBOARD_ALL_ITEM_BY_MO_START'
export const GET_DASHBOARD_BOM_ITEM_ROUTING_BY_MO_START =
  'MESX_GET_DASHBOARD_BOM_ITEM_ROUTING_BY_MO_START'
