export const SEARCH_PLANS_START = 'MESX_SEARCH_PLANS_START'
export const SEARCH_PLANS_SUCCESS = 'MESX_SEARCH_PLANS_SUCCESS'
export const SEARCH_PLANS_FAILED = 'MESX_SEARCH_PLANS_FAILED'

export const CREATE_PLAN_START = 'MESX_CREATE_PLAN_START'
export const CREATE_PLAN_SUCCESS = 'MESX_CREATE_PLAN_SUCCESS'
export const CREATE_PLAN_FAILED = 'MESX_CREATE_PLAN_FAILED'

export const UPDATE_PLAN_START = 'MESX_UPDATE_PLAN_START'
export const UPDATE_PLAN_SUCCESS = 'MESX_UPDATE_PLAN_SUCCESS'
export const UPDATE_PLAN_FAILED = 'MESX_UPDATE_PLAN_FAILED'

export const DELETE_PLAN_START = 'MESX_DELETE_PLAN_START'
export const DELETE_PLAN_SUCCESS = 'MESX_DELETE_PLAN_SUCCESS'
export const DELETE_PLAN_FAILED = 'MESX_DELETE_PLAN_FAILED'

export const GET_PLAN_DETAILS_START = 'MESX_GET_PLAN_DETAILS_START'
export const GET_PLAN_DETAILS_SUCCESS = 'MESX_GET_PLAN_DETAILS_SUCCESS'
export const GET_PLAN_DETAILS_FAILED = 'MESX_GET_PLAN_DETAILS_FAILED'

export const GET_MO_BY_PLAN_START = 'MESX_GET_MO_BY_PLAN_START'
export const GET_MO_BY_PLAN_SUCCESS = 'MESX_GET_MO_BY_PLAN_SUCCESS'
export const GET_MO_BY_PLAN_FAILED = 'MESX_GET_MO_BY_PLAN_FAILED'

export const CONFIRM_PLAN_START = 'MESX_CONFIRM_PLAN_START'
export const CONFIRM_PLAN_SUCCESS = 'MESX_CONFIRM_PLAN_SUCCESS'
export const CONFIRM_PLAN_FAILED = 'MESX_CONFIRM_PLAN_FAILED'

export const RESET_PLAN_LIST_STATE = 'MESX_RESET_PLAN_LIST_STATE'
