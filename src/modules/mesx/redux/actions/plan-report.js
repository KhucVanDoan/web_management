export const GET_PLAN_REPORT = 'MESX_GET_PLAN_REPORT'
export const GET_PLAN_REPORT_SUCCESS = 'MESX_GET_PLAN_REPORT_SUCCESS'
export const EXPORT_PLAN_REPORT = 'MESX_EXPORT_PLAN_REPORT'
export const EXPORT_PLAN_REPORT_SUCCESS = 'MESX_EXPORT_PLAN_REPORT_SUCCESS'
export const EXPORT_PLAN_REPORT_FAILED = 'MESX_EXPORT_PLAN_REPORT_FAILED'
/**
 * get plan report
