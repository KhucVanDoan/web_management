export const SEARCH_FACTORIES_START = 'MESX_SEARCH_FACTORIES_START'
export const SEARCH_FACTORIES_SUCCESS = 'MESX_SEARCH_FACTORIES_SUCCESS'
export const SEARCH_FACTORIES_FAILED = 'MESX_SEARCH_FACTORIES_FAILED'

export const CREATE_FACTORY_START = 'MESX_CREATE_FACTORY_START'
export const CREATE_FACTORY_SUCCESS = 'MESX_CREATE_FACTORY_SUCCESS'
export const CREATE_FACTORY_FAILED = 'MESX_CREATE_FACTORY_FAILED'

export const UPDATE_FACTORY_START = 'MESX_UPDATE_FACTORY_START'
export const UPDATE_FACTORY_SUCCESS = 'MESX_UPDATE_FACTORY_SUCCESS'
export const UPDATE_FACTORY_FAILED = 'MESX_UPDATE_FACTORY_FAILED'

export const DELETE_FACTORY_START = 'MESX_DELETE_FACTORY_START'
export const DELETE_FACTORY_SUCCESS = 'MESX_DELETE_FACTORY_SUCCESS'
export const DELETE_FACTORY_FAILED = 'MESX_DELETE_FACTORY_FAILED'

export const GET_FACTORY_DETAILS_START = 'MESX_GET_FACTORY_DETAILS_START'
export const GET_FACTORY_DETAILS_SUCCESS = 'MESX_GET_FACTORY_DETAILS_SUCCESS'
export const GET_FACTORY_DETAILS_FAILED = 'MESX_GET_FACTORY_DETAILS_FAILED'
...
export const RESET_FACTORY_DETAILS_STATE = 'MESX_RESET_FACTORY_DETAILS_STATE'
/**
 * Search warehouse
