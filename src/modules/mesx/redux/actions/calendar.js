export const GET_LIST_FACTORY_CALENDAR = 'MESX_GET_LIST_FACTORY_CALENDAR'
export const GET_LIST_FACTORY_CALENDAR_SUCCESS =
  'MESX_GET_LIST_FACTORY_CALENDAR_SUCCESS'
export const GET_LIST_FACTORY_CALENDAR_FAILED =
  'MESX_GET_LIST_FACTORY_CALENDAR_FAILED'

export const GET_DETAIL_FACTORY_CALENDAR = 'MESX_GET_DETAIL_FACTORY_CALENDAR'
export const GET_DETAIL_FACTORY_CALENDAR_SUCCESS =
  'MESX_GET_DETAIL_FACTORY_CALENDAR_SUCCESS'
export const GET_DETAIL_FACTORY_CALENDAR_FAILED =
  'MESX_GET_DETAIL_FACTORY_CALENDAR_FAILED'

export const GET_LIST_FACTORY_EVENT = 'MESX_GET_LIST_FACTORY_EVENT'
export const GET_LIST_FACTORY_EVENT_SUCCESS =
  'MESX_GET_LIST_FACTORY_EVENT_SUCCESS'
export const GET_LIST_FACTORY_EVENT_FAILED =
  'MESX_GET_LIST_FACTORY_EVENT_FAILED'

export const GET_DETAIL_FACTORY_EVENT = 'MESX_GET_DETAIL_FACTORY_EVENT_CALENDAR'
export const GET_DETAIL_FACTORY_EVENT_SUCCESS =
  'MESX_GET_DETAIL_FACTORY_EVENT_SUCCESS'
export const GET_DETAIL_FACTORY_EVENT_FAILED =
  'MESX_GET_DETAIL_FACTORY_EVENT_FAILED'

export const UPDATE_FACTORY_CALENDAR = 'MESX_UPDATE_FACTORY_CALENDAR'
export const UPDATE_FACTORY_CALENDAR_SUCCESS =
  'MESX_UPDATE_FACTORY_CALENDAR_SUCCESS'
export const UPDATE_FACTORY_CALENDAR_FAILED =
  'MESX_UPDATE_FACTORY_CALENDAR_FAILED'

export const CREATE_FACTORY_CALENDAR = 'MESX_CREATE_FACTORY_CALENDAR'
export const CREATE_FACTORY_CALENDAR_SUCCESS =
  'MESX_CREATE_FACTORY_CALENDAR_SUCCESS'
export const CREATE_FACTORY_CALENDAR_FAILED =
  'MESX_CREATE_FACTORY_CALENDAR_FAILED'

export const CREATE_FACTORY_CALENDAR_SETUP =
  'MESX_CREATE_FACTORY_CALENDAR_SETUP'
export const CREATE_FACTORY_CALENDAR_SETUP_SUCCESS =
  'MESX_CREATE_FACTORY_CALENDAR_SETUP_SUCCESS'
export const CREATE_FACTORY_CALENDAR_SETUP_FAILED =
  'MESX_CREATE_FACTORY_CALENDAR_SETUP_FAILED'
