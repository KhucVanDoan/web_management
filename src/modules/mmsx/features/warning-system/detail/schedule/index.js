...
const breadcrumbs = [
  ...
  {
    route: ROUTE.WARNING_SYSTEM.DETAIL.SCHEDULE.PATH,
    title: ROUTE.WARNING_SYSTEM.DETAIL.SCHEDULE.TITLE,
  },
]

const WarningScheduleDetail = () => {
        ...
        <Grid container justifyContent="center">
          <Grid item xl={11} xs={12}>
            <Grid container rowSpacing={4 / 3} columnSpacing={{ xl: 8, xs: 4 }}>
              ...
              <Grid item lg={6} xs={12}>
                <LV
                  label={t('warningList.formError.scheduleMaintenanceDate')}
...
export default WarningScheduleDetail
