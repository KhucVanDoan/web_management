import {
  ...
  CONFIRM_WAREHOUSE_TRANSFER_EBS_SUCCESS,
  CONFIRM_WAREHOUSE_TRANSFER_EBS_FAILED,
  ...
  CONFIRM_WAREHOUSE_IMPORT_SUCCESS,
  CONFIRM_WAREHOUSE_IMPORT_FAILED,
...
export default function warehouseTransfer(state = initialState, action) {
  switch (action.type) {
    ...
    case CONFIRM_WAREHOUSE_TRANSFER_EBS_START:
    ...
    case CONFIRM_WAREHOUSE_TRANSFER_EBS_FAILED:
    case CONFIRM_WAREHOUSE_TRANSFER_EBS_SUCCESS:
    ...
    case CONFIRM_WAREHOUSE_IMPORT_SUCCESS:
