export const GET_COMPANIES_START = 'DATABASE_GET_COMPANIES_START'
export const GET_COMPANIES_SUCCESS = 'DATABASE_GET_COMPANIES_SUCCESS'
export const GET_COMPANIES_FAILED = 'DATABASE_GET_COMPANIES_FAILED'

export const SEARCH_COMPANIES_START = 'DATABASE_SEARCH_COMPANIES_START'
export const SEARCH_COMPANIES_SUCCESS = 'DATABASE_SEARCH_COMPANIES_SUCCESS'
export const SEARCH_COMPANIES_FAILED = 'DATABASE_SEARCH_COMPANIES_FAILED'

export const CREATE_COMPANY_START = 'DATABASE_CREATE_COMPANY_START'
export const CREATE_COMPANY_SUCCESS = 'DATABASE_CREATE_COMPANY_SUCCESS'
export const CREATE_COMPANY_FAILED = 'DATABASE_CREATE_COMPANY_FAILED'

export const UPDATE_COMPANY_START = 'DATABASE_UPDATE_COMPANY_START'
export const UPDATE_COMPANY_SUCCESS = 'DATABASE_UPDATE_COMPANY_SUCCESS'
export const UPDATE_COMPANY_FAILED = 'DATABASE_UPDATE_COMPANY_FAILED'

export const DELETE_COMPANY_START = 'DATABASE_DELETE_COMPANY_START'
export const DELETE_COMPANY_SUCCESS = 'DATABASE_DELETE_COMPANY_SUCCESS'
export const DELETE_COMPANY_FAILED = 'DATABASE_DELETE_COMPANY_FAILED'

export const GET_COMPANY_DETAILS_START = 'DATABASE_GET_COMPANY_DETAILS_START'
export const GET_COMPANY_DETAILS_SUCCESS =
  'DATABASE_GET_COMPANY_DETAILS_SUCCESS'
export const GET_COMPANY_DETAILS_FAILED = 'DATABASE_GET_COMPANY_DETAILS_FAILED'

export const RESET_COMPANY_DETAILS_STATE =
  'DATABASE_RESET_COMPANY_DETAILS_STATE'
