...
export const GET_LIST_ITEM_DETAIL_RECIPT_SUCCESS =
  'WMSX_GET_LIST_ITEM_DETAIL_RECIPT_SUCCESS'
export const GET_LIST_ITEM_DETAIL_RECIPT_FAILED =
  'WMSX_GET_LIST_ITEM_DETAIL_RECIPT_FAILED'
export const GET_ITEM_START = 'WMSX_GET_ITEM_START'
export const GET_ITEM_SUCCESS = 'WMSX_GET_ITEM_SUCCESS'
export const GET_ITEM_FAILED = 'WMSX_GET_ITEM_FAILED'
...
export function getItem(inventoryCalendarId, onSuccess, onError) {
  return {
    type: GET_ITEM_START,
    payload: inventoryCalendarId,
    onSuccess: onSuccess,
 ...
 * @returns {object}
 */
export function getItemFailed() {
  return {
    type: GET_ITEM_FAILED,
  }
}
export function getListItemDetailRecipt(payload, onSuccess, onError) {
  return {
 ...
 * @returns {object}
 */
export function getListItemDetailReciptSuccess(payload) {
  return {
    type: GET_LIST_ITEM_DETAIL_RECIPT_SUCCESS,
    payload: payload,
  }
}
 ...
 * @returns {object}
 */
export function getListItemDetailReciptFailed() {
  return {
    type: GET_LIST_ITEM_DETAIL_RECIPT_FAILED,
  }
}
