...
import { getItemsApi } from '~/modules/wmsx/redux/sagas/common/get-items'
import { scrollToBottom } from '~/utils'

const ProductSettingTable = ({ items, arrayHelpers }) => {
        ...
        renderCell: (params, index) => {
          ...
          return (
            <Field.Autocomplete
              ...
              label={t('definePallet.item.name')}
              placeholder={t('definePallet.item.chooseProduct')}
              asyncRequest={(s) =>
        ...
        renderCell: (params, index) => {
          return (
            <Field.TextField
              ...
              label={t('definePallet.item.amount')}
              type="number"
  ...
  return (
    <>
      ...
      <Box mt={1}>
        ...
        >
          {t('definePallet.addProductButton')}
        </Button>
      </Box>
    </>
  )
...
ProductSettingTable.defaultProps = {
  items: [],
  arrayHelpers: {},
}
