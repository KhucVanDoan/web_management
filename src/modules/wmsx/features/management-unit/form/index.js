...
const ManagementUnitForm = () => {
  ...
  const MODE_MAP = {
    [ROUTE.MANAGEMENT_UNIT.CREATE.PATH]: MODAL_MODE.CREATE,
    [ROUTE.MANAGEMENT_UNIT.EDIT.PATH]: MODAL_MODE.UPDATE,
  }
  ...
  const getBreadcrumb = () => {
    ...
    switch (mode) {
      case MODAL_MODE.CREATE:
        breadcrumb.push({
          route: ROUTE.MANAGEMENT_UNIT.CREATE.PATH,
          title: ROUTE.MANAGEMENT_UNIT.CREATE.TITLE,
        })
        break
      case MODAL_MODE.UPDATE:
        breadcrumb.push({
          route: ROUTE.MANAGEMENT_UNIT.EDIT.PATH,
          title: ROUTE.MANAGEMENT_UNIT.EDIT.TITLE,
        })
        break
      default:
        break
  ...
  const getTitle = () => {
    switch (mode) {
      case MODAL_MODE.CREATE:
        return ROUTE.MANAGEMENT_UNIT.CREATE.TITLE
      case MODAL_MODE.UPDATE:
        return ROUTE.MANAGEMENT_UNIT.EDIT.TITLE
      default:
    }
  }
