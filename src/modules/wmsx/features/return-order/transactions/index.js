...
export const Transactions = () => {
  ...
  const breadcrumbs = [
    ...
    {
      title: ROUTE.RETURN_ORDER.TRANSACTIONS.LIST.TITLE,
    },
  ]
  ...
  const movementType =
    ...
    ',' +
    MOVEMENT_TYPE.RETURN_IMPORT +
    ',' +
    MOVEMENT_TYPE.RETURN_EXPORT
...
export const TransactionDetail = () => {
  ...
  const breadcrumbs = [
    ...
    {
      route: ROUTE.RETURN_ORDER.TRANSACTIONS.LIST.PATH.replace(
        ':parentId',
        `${parentId}`,
      ),
      title: ROUTE.RETURN_ORDER.TRANSACTIONS.LIST.TITLE,
    ...
    {
      title: ROUTE.RETURN_ORDER.TRANSACTIONS.DETAIL.TITLE,
    },
  ]
