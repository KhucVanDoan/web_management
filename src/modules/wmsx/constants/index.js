...
export const TYPE_DOWLOAD_WAREHOUSE_EXPORT_RECEIPT = {
  DELIVERY_RECCEIPT: 1,
...
export const CONST_EXPORT_MASTER_DATA = {
  ...
  MATERIAL_CATEGORY: 2,
  WAREHOUSE_IMPORT_RECEIPT: 9,
  WAREHOUSE_EXPORT_RECEIPT: 10,
  DEFINE_OBJECT_CATEGORY: 7,
  DEFINE_MATERIAL_QUALITY: 8,
  DEFINE_EXPENDITURE_ORG: 11,
  DEFINE_EXPENDITURE_TYPE: 12,
}
