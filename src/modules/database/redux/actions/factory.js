export const SEARCH_FACTORIES_START = 'DATABASE_SEARCH_FACTORIES_START'
export const SEARCH_FACTORIES_SUCCESS = 'DATABASE_SEARCH_FACTORIES_SUCCESS'
export const SEARCH_FACTORIES_FAILED = 'DATABASE_SEARCH_FACTORIES_FAILED'

export const CREATE_FACTORY_START = 'DATABASE_CREATE_FACTORY_START'
export const CREATE_FACTORY_SUCCESS = 'DATABASE_CREATE_FACTORY_SUCCESS'
export const CREATE_FACTORY_FAILED = 'DATABASE_CREATE_FACTORY_FAILED'

export const UPDATE_FACTORY_START = 'DATABASE_UPDATE_FACTORY_START'
export const UPDATE_FACTORY_SUCCESS = 'DATABASE_UPDATE_FACTORY_SUCCESS'
export const UPDATE_FACTORY_FAILED = 'DATABASE_UPDATE_FACTORY_FAILED'

export const DELETE_FACTORY_START = 'DATABASE_DELETE_FACTORY_START'
export const DELETE_FACTORY_SUCCESS = 'DATABASE_DELETE_FACTORY_SUCCESS'
export const DELETE_FACTORY_FAILED = 'DATABASE_DELETE_FACTORY_FAILED'

export const GET_FACTORY_DETAILS_START = 'DATABASE_GET_FACTORY_DETAILS_START'
export const GET_FACTORY_DETAILS_SUCCESS =
  'DATABASE_GET_FACTORY_DETAILS_SUCCESS'
export const GET_FACTORY_DETAILS_FAILED = 'DATABASE_GET_FACTORY_DETAILS_FAILED'

export const GET_FACTORIES_START = 'DATABASE_GET_FACTORIES_START'
export const GET_FACTORIES_SUCCESS = 'DATABASE_GET_FACTORIES_SUCCESS'
export const GET_FACTORIES_FAILED = 'DATABASE_GET_FACTORIES_FAILED'

export const RESET_FACTORY_DETAILS_STATE =
  'DATABASE_RESET_FACTORY_DETAILS_STATE'
/**
 * Search warehouse
