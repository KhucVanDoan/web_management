export const SEARCH_ITEM_UNITS_START = 'DATABASE_SEARCH_ITEM_UNITS_START'
export const SEARCH_ITEM_UNITS_SUCCESS = 'DATABASE_SEARCH_ITEM_UNITS_SUCCESS'
export const SEARCH_ITEM_UNITS_FAILED = 'DATABASE_SEARCH_ITEM_UNITS_FAILED'

export const CREATE_ITEM_UNIT_START = 'DATABASE_CREATE_ITEM_UNIT_START'
export const CREATE_ITEM_UNIT_SUCCESS = 'DATABASE_CREATE_ITEM_UNIT_SUCCESS'
export const CREATE_ITEM_UNIT_FAILED = 'DATABASE_CREATE_ITEM_UNIT_FAILED'

export const UPDATE_ITEM_UNIT_START = 'DATABASE_UPDATE_ITEM_UNIT_START'
export const UPDATE_ITEM_UNIT_SUCCESS = 'DATABASE_UPDATE_ITEM_UNIT_SUCCESS'
export const UPDATE_ITEM_UNIT_FAILED = 'DATABASE_UPDATE_ITEM_UNIT_FAILED'

export const DELETE_ITEM_UNIT_START = 'DATABASE_DELETE_ITEM_UNIT_START'
export const DELETE_ITEM_UNIT_SUCCESS = 'DATABASE_DELETE_ITEM_UNIT_SUCCESS'
export const DELETE_ITEM_UNIT_FAILED = 'DATABASE_DELETE_ITEM_UNIT_FAILED'

export const GET_ITEM_UNIT_DETAILS_START =
  'DATABASE_GET_ITEM_UNIT_DETAILS_START'
export const GET_ITEM_UNIT_DETAILS_SUCCESS =
  'DATABASE_GET_ITEM_UNIT_DETAILS_SUCCESS'
export const GET_ITEM_UNIT_DETAILS_FAILED =
  'DATABASE_GET_ITEM_UNIT_DETAILS_FAILED'

export const RESET_ITEM_UNIT_DETAILS_STATE =
  'DATABASE_RESET_ITEM_UNIT_DETAILS_STATE'
