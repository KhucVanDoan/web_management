export const SEARCH_SALE_ORDERS_START = 'DATABASE_SEARCH_SALE_ORDERS_START'
export const SEARCH_SALE_ORDERS_SUCCESS = 'DATABASE_SEARCH_SALE_ORDERS_SUCCESS'
export const SEARCH_SALE_ORDERS_FAILED = 'DATABASE_SEARCH_SALE_ORDERS_FAILED'

export const CREATE_SALE_ORDER_START = 'DATABASE_CREATE_SALE_ORDER_START'
export const CREATE_SALE_ORDER_SUCCESS = 'DATABASE_CREATE_SALE_ORDER_SUCCESS'
export const CREATE_SALE_ORDER_FAILED = 'DATABASE_CREATE_SALE_ORDER_FAILED'

export const UPDATE_SALE_ORDER_START = 'DATABASE_UPDATE_SALE_ORDER_START'
export const UPDATE_SALE_ORDER_SUCCESS = 'DATABASE_UPDATE_SALE_ORDER_SUCCESS'
export const UPDATE_SALE_ORDER_FAILED = 'DATABASE_UPDATE_SALE_ORDER_FAILED'

export const DELETE_SALE_ORDER_START = 'DATABASE_DELETE_SALE_ORDER_START'
export const DELETE_SALE_ORDER_SUCCESS = 'DATABASE_DELETE_SALE_ORDER_SUCCESS'
export const DELETE_SALE_ORDER_FAILED = 'DATABASE_DELETE_SALE_ORDER_FAILED'

export const GET_SALE_ORDER_DETAILS_START =
  'DATABASE_GET_SALE_ORDER_DETAILS_START'
export const GET_SALE_ORDER_DETAILS_SUCCESS =
  'DATABASE_GET_SALE_ORDER_DETAILS_SUCCESS'
export const GET_SALE_ORDER_DETAILS_FAILED =
  'DATABASE_GET_SALE_ORDER_DETAILS_FAILED'

export const CONFIRM_SALE_ORDER_START = 'DATABASE_CONFIRM_SALE_ORDER_START'
export const CONFIRM_SALE_ORDER_SUCCESS = 'DATABASE_CONFIRM_SALE_ORDER_SUCCESS'
export const CONFIRM_SALE_ORDER_FAILED = 'DATABASE_CONFIRM_SALE_ORDER_FAILED'

export const REJECT_SALE_ORDER_START = 'DATABASE_REJECT_SALE_ORDER_START'
export const REJECT_SALE_ORDER_SUCCESS = 'DATABASE_REJECT_SALE_ORDER_SUCCESS'
export const REJECT_SALE_ORDER_FAILED = 'DATABASE_REJECT_SALE_ORDER_FAILED'

export const RESET_SALE_ORDER_STATE = 'DATABASE_RESET_SALE_ORDER_STATE'
export const RESET_SALE_ORDER_LIST_STATE =
  'DATABASE_RESET_SALE_ORDER_LIST_STATE'

export const GET_SALE_ORDER_DETAIL_BY_IDS_START =
  'DATABASE_GET_SALE_ORDER_DETAIL_BY_IDS_START'
export const GET_SALE_ORDER_DETAIL_BY_IDS_SUCCESS =
  'DATABASE_GET_SALE_ORDER_DETAIL_BY_IDS_SUCCESS'
